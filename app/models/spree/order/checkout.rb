        ...
        klass.class_eval do
          ...
          def self.define_state_machine!
            ...
            state_machine :state, initial: :cart, use_transactions: false, action: :save_state do
              ...
              # before_transition to: :complete, do: :update_line_item_prices!
              # before_transition to: :complete, do: :create_tax_charge!
              # before_transition to: :complete, do: :assign_default_addresses!
          ...
          def update_from_params(params, permitted_params, request_env = {})
            ...
            run_callbacks :updating_from_params do
              ...
              attributes = @updating_params[:order] ? ActionController::Parameters.new(@updating_params[:order].select{|k,v| v.present?}).permit(permitted_params).delete_if { |_k, v| v.nil? } : {}              
              ...
              # p "\n\n\nattributesattributesattributesattributes=["+attributes.to_json+"]\n\n\n"
              success =  true       
              puts "\n\n\n\n permitted_params=["+permitted_params.to_json+"]\n\n\n update_from_params attributes=["+attributes.to_json+"]\n\n\n\n"
          ...
          def update_params_payment_source
            if @updating_params[:payment_source].present?
              source_params = @updating_params.
                              delete(:payment_source)[@updating_params[:order][:payments_attributes].first[:payment_method_id].to_s]

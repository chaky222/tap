...
module Spree
  class Order < Spree::Base
    ...
    self.whitelisted_ransackable_associations = %w[shipments user promotions bill_address ship_address line_items checkout]
    self.whitelisted_ransackable_attributes = %w[completed_at email number state payment_state shipment_state total considered_risky checkout]
    ...
    # attr_accessible :checkout, :params
    ...
    def selected_payment_method_id      
      ((self.selected_payment_method) && (self.selected_payment_method > 0)) || @available_payment_methods.first.id
    end
    ...
    def create_proposed_shipments
      unless shipments.any?
        ...
        puts "\n\n\n create_proposed_shipments shipments=["+self.shipments.to_json+"]\n\n\n\n"
      end;
    end
